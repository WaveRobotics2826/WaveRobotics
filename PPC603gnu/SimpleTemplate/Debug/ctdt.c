...
void _GLOBAL__I__ZN14WaveCompressorC2EP16DriverStationLCD();

void _GLOBAL__I__ZN16WaveRobotProjectC2Ev();

void _GLOBAL__I__ZN16WaveWheelControlC2EP16DriverStationLCD();

void _GLOBAL__I__ZN17WaveIntakeControlC2Eiid();

void _GLOBAL__I__ZN17WaveTurretControlC2Ev();

void _GLOBAL__I__ZN18WaveDeliverySystemC2Eii();

void _GLOBAL__I__ZN9WaveDriveC2EiiP8Joystick();
...
void (*_ctors[])() =
    {
    _GLOBAL__I__ZN14WaveCompressorC2EP16DriverStationLCD,
    _GLOBAL__I__ZN16WaveRobotProjectC2Ev,
    _GLOBAL__I__ZN16WaveWheelControlC2EP16DriverStationLCD,
    _GLOBAL__I__ZN17WaveIntakeControlC2Eiid,
    _GLOBAL__I__ZN17WaveTurretControlC2Ev,
    _GLOBAL__I__ZN18WaveDeliverySystemC2Eii,
    _GLOBAL__I__ZN9WaveDriveC2EiiP8Joystick,
...
void _GLOBAL__D__ZN14WaveCompressorC2EP16DriverStationLCD();

void _GLOBAL__D__ZN16WaveRobotProjectC2Ev();

void _GLOBAL__D__ZN16WaveWheelControlC2EP16DriverStationLCD();

void _GLOBAL__D__ZN17WaveIntakeControlC2Eiid();

void _GLOBAL__D__ZN17WaveTurretControlC2Ev();

void _GLOBAL__D__ZN18WaveDeliverySystemC2Eii();

void _GLOBAL__D__ZN9WaveDriveC2EiiP8Joystick();
...
void (*_dtors[])() =
    {
    _GLOBAL__D__ZN14WaveCompressorC2EP16DriverStationLCD,
    _GLOBAL__D__ZN16WaveRobotProjectC2Ev,
    _GLOBAL__D__ZN16WaveWheelControlC2EP16DriverStationLCD,
    _GLOBAL__D__ZN17WaveIntakeControlC2Eiid,
    _GLOBAL__D__ZN17WaveTurretControlC2Ev,
    _GLOBAL__D__ZN18WaveDeliverySystemC2Eii,
    _GLOBAL__D__ZN9WaveDriveC2EiiP8Joystick,
